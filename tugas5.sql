-- Soal 1 : buatlah sebuah database dengan nama books_store ;
...
--Soal 2 : setelah berhasil membuat tabel books , kemudian masukan 10 data baru meliputi struktur seperti dibawah ini :
...
--Soal 3 : buatlah skrip untuk menampilkan semua data pada table books & category
SELECT * FROM `books`
--======================================--
...
-- Soal 5 : buatlah skrip untuk menghapus data dengan id 10 pada tabel books & category
DELETE FROM `books` WHERE id_buku = 10;
--=============================================--
DELETE FROM `category` WHERE id_category = 10;

-- Soal 6 : buatlah skrip untuk menampilkan data judul buku dengan penerbit Addison-Wesley
...
-- Soal 7 :buatlah skrip untuk membuat tabel book_categories dengan struktur sebagai berikut :
...
-- Soal 8 :buatlah skrip untuk menambahkan 3 data kedalam tabel book_categories sebagai berikut :
...
-- Soal 9 : buatlah skrip untuk menampilkan data pada books dengan data pada category
...
-- Soal 10 :buatlah skrip untuk menambahkan kolom jumlah halaman dengan tipe data number
